                        ...
                        <div>
                            ...
                            <div className="mt-1 flex flex-col space-y-4">
                                ...
                                <div
                                    ...
                                    onDrop={handleDrop}
                                    className={`flex justify-center px-4 sm:px-6 pt-4 pb-4 sm:pb-6 border-2 ${isDragging
                                            ? 'border-gray-400 bg-gray-50'
                                            : 'border-gray-300 border-dashed'
                                        } rounded-lg hover:border-gray-400 transition-all duration-200 cursor-pointer`}
                                >
